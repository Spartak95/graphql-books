package com.xcoder.graphqlbooks;
...
import com.xcoder.graphqlbooks.review.Review;
import com.xcoder.graphqlbooks.review.ReviewRepository;
...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        AuthorsAndBooks authorsAndBooks = loadAuthorsAndBooks();
    ...
    private void loadReviews(AuthorsAndBooks data) {
        ...
        review1.setRating(5);
        review1.setComment(
            "Exceptional deep dive into Cloud Native Java! Josh's expertise shines through every chapter.");
        ...
        review2.setRating(5);
        review2.setComment(
            "A masterpiece on Cloud Native Java. The examples are practical and the concepts are explained brilliantly!");
        ...
        review4.setRating(5);
        review4.setComment(
            "Comprehensive coverage from basics to advanced topics. A must-read for any Spring developer!");
        ...
        review5.setRating(5);
        review5.setComment(
            "Greg's expertise makes Spring Boot approachable and exciting. Best technical book I've read this year!");
